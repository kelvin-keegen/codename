...
import com.mobi_apps.kelvinkeegan.codenamealarmclock.preferences.AlarmPreferencesActivity;
...
public abstract class BaseActivity  extends AppCompatActivity implements android.view.View.OnClickListener{
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_item_website:
			url = "http://stackoverflow.com/story/keeganapps";
			intent = new Intent(Intent.ACTION_VIEW);
			intent.setData(Uri.parse(url));
			try {
				startActivity(intent);
		...
		case R.id.menu_item_report:
			...
			break;
			case R.id.help:
				Intent assist = new Intent(BaseActivity.this,helpme.class);
			...
			String emailAddress = "kelvinkeegen17@gmail.com";
