...
import com.mobi_apps.kelvinkeegan.codenamealarmclock.BaseActivity;
...
import com.mobi_apps.kelvinkeegan.codenamealarmclock.alert.AlarmAlertActivity;
import com.mobi_apps.kelvinkeegan.codenamealarmclock.database.Database;
					...
					alert.setItems(items, new OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							case ALARM_DIFFICULTY:
								IntentIntegrator integrator = new IntentIntegrator(AlarmPreferencesActivity.this);
								integrator.initiateScan();
								Toast.makeText(AlarmPreferencesActivity.this, "Tests your QRCode scanner", Toast.LENGTH_SHORT).show();
								break;
							case ALARM_TONE:
