package com.mobi_apps.kelvinkeegan.codenamealarmclock.preferences;
...
public class AlarmPreferenceListAdapter extends BaseAdapter implements Serializable {
	...
	private final String[] alarmDifficulties = {"Test Now"};
...
//
	...
	public void setMathAlarm(Alarm alarm) {
		...
		preferences.add(new AlarmPreference(AlarmPreference.Key.ALARM_NAME, "Mode",alarm.getAlarmName(), null, alarm.getAlarmName(), AlarmPreference.Type.STRING));
		preferences.add(new AlarmPreference(AlarmPreference.Key.ALARM_TIME, "Set the time",alarm.getAlarmTimeString(), null, alarm.getAlarmTime(), AlarmPreference.Type.TIME));
		preferences.add(new AlarmPreference(AlarmPreference.Key.ALARM_REPEAT, "Repeating days are",alarm.getRepeatDaysString(), repeatDays, alarm.getDays(), AlarmPreference.Type.MULTIPLE_LIST));
		preferences.add(new AlarmPreference(AlarmPreference.Key.ALARM_DIFFICULTY,"QRCode Test", alarm.getDifficulty().toString(), alarmDifficulties, alarm.getDifficulty(), AlarmPreference.Type.LIST));
